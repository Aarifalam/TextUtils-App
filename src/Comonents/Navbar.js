            ...
            <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {/* this Button is for to Enable Dark or Light Mode */}
...
Navbar.prototype = {
    title: PropTypes.string.isRequired, //title is requred if you will not paas title value in App.js then it will gives Error
